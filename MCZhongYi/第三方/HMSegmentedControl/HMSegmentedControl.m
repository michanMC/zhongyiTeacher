...
- (void)commonInit {
    ...
    self.opaque = NO;
    _selectionIndicatorColor =AppCOLOR;// [UIColor colorWithRed:52.0f/255.0f green:181.0f/255.0f blue:229.0f/255.0f alpha:1.0f];
    ...
    _verticalDividerColor = [UIColor darkTextColor];
