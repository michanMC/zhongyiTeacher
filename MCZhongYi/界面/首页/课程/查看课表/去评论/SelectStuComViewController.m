...
#import "SelectStuComViewController.h"
#import "ZJScrollPageView.h"
#import "NoStuComViewController.h"
#import "HasStuComViewController.h"
@interface SelectStuComViewController ()<ZJScrollPageViewDelegate>
{
...
@implementation SelectStuComViewController
...
- (UIViewController<ZJScrollPageViewChildVcDelegate> *)childViewController:(UIViewController<ZJScrollPageViewChildVcDelegate> *)reuseViewController forIndex:(NSInteger)index {
    ...
    if (!childVc) {
        if (index == 0) {
            childVc = [[NoStuComViewController alloc]init];
        }
        else if (index == 1)
        {
            childVc = [[HasStuComViewController alloc]init];
