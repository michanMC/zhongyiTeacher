...
@interface LookClass3ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation LookClass3ViewController
...
-(void)actionTepyBtn:(UIButton*)btn{
    ...
    SelectStuComViewController * ctl =[[SelectStuComViewController alloc]init];
