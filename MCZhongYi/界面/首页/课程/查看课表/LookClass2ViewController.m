...
@interface LookClass2ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation LookClass2ViewController
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell prepareUI:1];
    [cell.tepyBtn addTarget:self action:@selector(actionTepyBtn:) forControlEvents:1<<6];
    return cell;
    //    return cell;
...
-(void)actionTepyBtn:(UIButton*)btn{
    ...
    ClassSummaryViewController * ctl =[[ClassSummaryViewController alloc]init];
