...
@interface LookClass4ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation LookClass4ViewController
...
-(void)actionTepyBtn:(UIButton*)btn{
    ...
    LookSummaryViewController * ctl =[[LookSummaryViewController alloc]init];
